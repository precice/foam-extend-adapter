...
#if (defined(PTRACE_GETSIGINFO) && defined(PTRACE_SETSIGINFO)) || (defined(PT_GETSIGINFO) && defined(PT_SETSIGINFO))
...
#else
COMPILER_CHECK(sizeof(((__sanitizer_ifaddrs*)NULL)->ifa_dstaddr) == sizeof(((ifaddrs*)NULL)->ifa_ifu));
COMPILER_CHECK(offsetof(__sanitizer_ifaddrs, ifa_dstaddr) == offsetof(ifaddrs, ifa_ifu));
