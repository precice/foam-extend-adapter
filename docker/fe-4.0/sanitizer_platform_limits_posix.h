...
#if SANITIZER_LINUX && !SANITIZER_ANDROID && (defined(__i386) || defined(__x86_64))
...
#define CHECK_SIZE_AND_OFFSET(CLASS, MEMBER)                                                        \
    COMPILER_CHECK(sizeof(((__sanitizer_##CLASS*)NULL)->MEMBER) == sizeof(((CLASS*)NULL)->MEMBER)); \
    COMPILER_CHECK(offsetof(__sanitizer_##CLASS, MEMBER) == offsetof(CLASS, MEMBER))

// For sigaction, which is a function and struct at the same time,
// and thus requires explicit "struct" in sizeof() expression.
#define CHECK_STRUCT_SIZE_AND_OFFSET(CLASS, MEMBER)                                                               \
    COMPILER_CHECK(sizeof(((struct __sanitizer_##CLASS*)NULL)->MEMBER) == sizeof(((struct CLASS*)NULL)->MEMBER)); \
    COMPILER_CHECK(offsetof(struct __sanitizer_##CLASS, MEMBER) == offsetof(struct CLASS, MEMBER))
